...
void exampleBlue() { // The example function for a blue side. This could have coordinate callbacks or anything else

}

void exampleRed() { //The example function for a red side. This gets paired with the blue (to make one menu item)

}

void skillsAuton() { // Look for ways to implement odom effectively in future seasons
